...
apgw_lb_name = "bos-dev-appgateway"
...
).format(SUBSCRIPTION_ID, resource_group_name, apgw_lb_name)
...
# Get CpuUtilization average of last 12 hours for this APP_GW_LB, by half an hour
